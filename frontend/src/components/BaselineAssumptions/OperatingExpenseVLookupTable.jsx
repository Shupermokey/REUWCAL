...
function OperatingExpenseVLookupTable({isBase}) {
  return (
    ...
    <tr className='acquisition-radio-assumptions-row'>
      <th className='acquisition-radio-assumptions-cell'>Code</th>
      <th className='acquisition-radio-assumptions-cell'>RE TAX Recovery Rate</th>
      <th className='acquisition-radio-assumptions-cell'>RE INSx</th>
      <th className='acquisition-radio-assumptions-cell'>RE INSx, Recovery Rate</th>
      <th className='acquisition-radio-assumptions-cell'>ComUtilityX</th>
      <th className='acquisition-radio-assumptions-cell'>ComUtilityX, Recovery Rate</th>
      <th className='acquisition-radio-assumptions-cell'>CAMx</th>
      <th className='acquisition-radio-assumptions-cell'>CAMx, Recovery Rate</th>
      <th className='acquisition-radio-assumptions-cell'>RepairX</th>
      <th className='acquisition-radio-assumptions-cell'>RepairX, Recovery Rate</th>
      <th className='acquisition-radio-assumptions-cell'>MNGMTx</th>
      <th className='acquisition-radio-assumptions-cell'>MNGMTx, Recovery Rate</th>
      <th className='acquisition-radio-assumptions-cell'>CAPx</th>
      <th className='acquisition-radio-assumptions-cell'>CAPx, Recovery Rate</th>
      <th className='acquisition-radio-assumptions-cell'>Landlord Responsibilities</th>
      <th className='acquisition-radio-assumptions-cell'>Tenant Responsibilities</th>
    </tr>
...
export default OperatingExpenseVLookupTable